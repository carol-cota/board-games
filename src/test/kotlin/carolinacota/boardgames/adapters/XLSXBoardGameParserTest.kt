...
internal class XLSXBoardGameParserTest {
    private val file = ClassPathResource("board-games-test.xlsx").file.toPath().toAbsolutePath().toString()
    private val boardGameParser = XLSXBoardGameParser(file)

    @Test
    fun `should return 7 elements`() {
        val result = boardGameParser.call()
    ...
    fun `elements should have correct ids`() {
        ...
        val result = boardGameParser.call().map { it.id }
    ...
    fun `elements should have correct names`() {
        ...
        val result = boardGameParser.call().map { it.name }
    ...
    fun `elements should have correct number of ratings`() {
        ...
        val result = boardGameParser.call().map { it.numberOfRatings }
    ...
    fun `should have correct rating average`() {
        ...
        val result = boardGameParser.call().map { it.ratingAverage }
